...
<?php
if(isset($_POST['submit'])) {
    // Existing code for other form data

    // File upload handling
    $targetDirectory = "uploads/"; // Directory to save uploaded PDF files
    ...
    if ($_FILES["pdfFile"]["size"] > 500000) { // Adjust file size limit as needed
    ...
    // if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["pdfFile"]["tmp_name"], $targetFile)) {
            echo "<script>alert('The file ". htmlspecialchars( basename( $_FILES["pdfFile"]["name"])). " has been uploaded.');</script>";
            $pdfFilePath = $targetFile;
            // Now you have $pdfFilePath to save in the database along with other details
        } else {
